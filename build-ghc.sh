...
docker build -f GHC.Dockerfile --no-cache \
        --platform linux/amd64 \
        --build-arg C_UBUNTU_IMG=$1 \
        --build-arg GHC_VERSION=$2 \
        --build-arg CABAL_VERSION=$3 \
        -t "adalove/ubuntu:$1-ghc$2-c$3_amd64" .

docker push "adalove/ubuntu:$1-ghc$2-c$3_amd64"
...
docker build -f GHC.Dockerfile --no-cache \
        ...
        --build-arg GHC_VERSION=$2 \
        --build-arg CABAL_VERSION=$3 \
        -t "adalove/ubuntu:$1-ghc$2-c$3_arm64" .

docker push "adalove/ubuntu:$1-ghc$2-c$3_arm64"
